...
func InitOptionMap() {
	...
	common.OptionMap["OffPeakModelRatio"] = ratio_setting.OffPeakModelRatio2JSONString()
	common.OptionMap["PeakTimeWindow"] = ""
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "OffPeakModelRatio":
		err = ratio_setting.UpdateOffPeakModelRatioByJSONString(value)
	case "PeakTimeWindow":
		ratio_setting.SetPeakTimeWindow(value)
	case "GroupRatio":
